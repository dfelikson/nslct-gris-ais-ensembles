...
pos = md0.mask.ice_levelset<0 & md0.inversion.vel_obs>1000;
vel_diff_0 = md0.results.StressbalanceSolution.Vel(pos) - md0.inversion.vel_obs(pos);
...
close all;
figure; hold on;
histogram(vel_diff_0, 1000, 'FaceAlpha', 0.5);
