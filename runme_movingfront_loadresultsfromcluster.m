if exist(['./models/' branch '/' branch '.movingfront.' ensembleID '.ssa.tr'], 'file')
   fprintf(['Model already exists: ./models/' branch '/' branch '.movingfront.' ensembleID '.ssa.tr. Skipping runme_movingfront_loadresultsfromcluster.m!\n']);
   return
end
